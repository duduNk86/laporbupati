...
class M_album extends CI_Model{
	...
	function simpan_album($album,$user_id,$user_nama,$gambar){
		$hsl=$this->db->query("insert into tbl_album(album_nama,album_admin_id,album_author,album_cover) values ('$album','$user_id','$user_nama','$gambar')");
		return $hsl;
	}
	...
	function update_album($album_id,$album_nama,$user_id,$user_nama,$gambar){
		$hsl=$this->db->query("update tbl_album set album_nama='$album_nama',album_admin_id='$user_id',album_author='$user_nama',album_cover='$gambar' where album_id='$album_id'");
		return $hsl;
	}
	function update_album_tanpa_img($album_id,$album_nama,$user_id,$user_nama){
		$hsl=$this->db->query("update tbl_album set album_nama='$album_nama',album_admin_id='$user_id',album_author='$user_nama' where album_id='$album_id'");
		return $hsl;
	}
