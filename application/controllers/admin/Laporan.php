...
class Laporan extends CI_Controller{
	...
	function get_ditolak(){
		$x['title']="Lapor Bupati";
		$data=$this->m_laporan->get_all_laporan_ditolak()->result();
		echo json_encode($data);
	}	
	...
	function simpan_laporan(){
		...
		$sumber_aduan=$this->input->post('x_sumberaduan');
	...
	function copy_laporan(){
		...
		$sumber_aduan=$this->input->post('x_sumberaduan_copy');
	...
	function update_laporan(){
		...
		$sumber_aduan=$this->input->post('x_sumberaduan_edit');
		...
		// }
			...
			$data= array(
				...
				// 'id_penginput'=>$id_penginput, PERUBAHAN DISINI
				// 'penginput'=>$this->session->userdata('pengguna_nama'), PERUBAHAN DISINI
	...
	// Kirim WA Guzzle
	// public function send_whatsapp_message($whatsapp, $message2, $token) {
    //     $client = new Client();
    //     $url = 'https://api.chat-api.com/instance' . $token . '/sendMessage';
	...
	function update_teruskan(){
        ...
        // Jika status code adalah 201, berarti pesan berhasil terkirim
        // if ($statusCode === 201) {
        //     $data = [
        //         'success' => true,
        //         'message' => 'Pesan WhatsApp berhasil dikirim ke ' . $whatsapp
        //     ];
        // } else {
        //     // Jika status code bukan 201, berarti terjadi error
        //     $data = [
        //         'success' => false,
        //         'message' => 'Pesan WhatsApp gagal dikirim. Error code: ' . $statusCode
        //     ];
        // }
		...
		// $url_whatsapp = 'https://web.whatsapp.com/send?phone=' . $whatsapp . '&text=' . urlencode($message2);
