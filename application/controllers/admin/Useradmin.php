...
class Useradmin extends CI_Controller
{
	...
	function add_pengguna()
	{
		...
		$pengguna_nohp_pimpinan = $this->input->post('x_pengguna_nohp_pimpinan');
		...
		$data = array(
			...
			'pengguna_nohp_pimpinan' => $pengguna_nohp_pimpinan,
	...
	function update_pengguna()
	{
		...
		$pengguna_nohp_pimpinan = $this->input->post('x_pengguna_nohp_pimpinan_edit');
