    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url() . 'admin/kategori_laporan' ?>">Kategori</a></li>
                  ...
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><a href="<?php echo base_url() . 'admin/kategori_laporan' ?>"><?php echo $kategori_nama; ?></a></td>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/kategori_laporan/simpan_subkategori' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Sub-Kategori</label>
              <div class="col-sm-7">
                <input type="text" name="xsubkategori" class="form-control" id="inputUserName" placeholder="Sub-Kategori" required>
              </div>
            </div>
          </div>
    ...
    <div class="modal fade" id="ModalEdit<?php echo $subkategori_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
            <h4 class="modal-title" id="myModalLabel">Ubah Sub-Kategori</h4>
          </div>
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/kategori_laporan/update_subkategori' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Kategori</label>
                <div class="col-sm-7">
                  <input type="text" name="xkategori" class="form-control" id="inputUserName" value="<?php echo $kategori_nama; ?>" placeholder="Sub-Kategori" disabled>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Sub-Kategori</label>
                <div class="col-sm-7">
                  ...
                  <input type="text" name="xsubkategori" class="form-control" id="inputUserName" value="<?php echo $subkategori_nama; ?>" placeholder="Sub-Kategori" required>
                </div>
              </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal fade" id="ModalHapus<?php echo $subkategori_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/kategori_laporan/hapus_subkategori' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $subkategori_id; ?>" />
              <p>Apakah Anda yakin mau menghapus Pengguna <b><?php echo $subkategori_nama; ?></b> ?</p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
