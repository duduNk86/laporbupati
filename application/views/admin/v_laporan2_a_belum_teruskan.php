     ...
     <div class="modal fade" id="ModalTeruskan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form id="form_teruskan" class="form-horizontal" action="<?php echo base_url().'admin/laporan/update_laporan'?>" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                  <select class="form-control select2" name="xidkepada_teruskan" id="xidkepada_teruskan" style="width: 100%;" required>
                        <option value="">-Pilih-</option>
                        <?php
                        $no=0;
                ...
                <div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">Judul Aduan</label>
                  <div class="col-sm-7">
                    <input type="text" name="xjudullaporan_teruskan"  class="form-control" id="xjudullaporan_teruskan" placeholder="Nama Agenda" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">Isi Aduan</label>
                  <div class="col-sm-7">
                    <textarea class="form-control" rows="3" name="xisilaporan_teruskan" id="xisilaporan_teruskan" required></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">Keterangan</label>
                  <div class="col-sm-7">
                    <input type="text" name="xketeranganstatus_teruskan" class="form-control" id="xketeranganstatus_teruskan" placeholder="Keterangan" required>
                  </div>
                </div>
              </div>
              <div class="modal-footer">
                    ...
                    laporan_status = '<span class="label label-info">selesai</span>';
		                ...
		                html += '<tr>'+
		                        ...
		                        '<td style="text-align:right;">'+
                                    ...
                                    '<a href="javascript:;" class="btn btn-info btn-xs item_teruskan" data="'+data[i].id+'">teruskan</a>'+' '+
                                '</td>'+
		                        '</tr>';
		            }
		...
		$('#tbl_laporan').on('click','.item_edit',function(){
            ...
            $.ajax({
                ...
                success: function(data){
                  ...
                  $('[name="xkode_edit"]').val(data.id);
            			$('[name="xditujukankepada"]').val(data.ditujukan_kepada);
            			$('[name="x_judullaporan"]').val(data.judul_laporan);
            			$('[name="x_isilaporan"]').val(data.isi_laporan);
            			$('[name="x_nama"]').val(data.nama);
            			$('[name="x_lokasi"]').val(data.lokasi);
            			$('[name="x_email"]').val(data.email);
                  $('[name="x_tanggallaporan"]').val(data.tanggal_laporan);
                  $('[name="x_laporanstatus"]').val(data.laporan_status);
                  $('[name="xketeranganstatus"]').val(data.keterangan_status);
