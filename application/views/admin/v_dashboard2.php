            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <center>
                  ...
                  <p><h2 data-toggle="modal" data-target="#ModalCustomStatistik2">Proses</h2></p>
                </center>
              </div>
              <div class="icon">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              ...
              <a href="<?php echo base_url().'admin/inbox'?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
            ...
            <div class="card">
                <div class="box box-danger">
                  <div class="card-header">
                    <h3 class="m-0 font-weight-bold text-black" align="center" style="margin-top:21pt;margin-bottom:17pt;"><b>Top #10 Topik Aduan</b></h3>
                  </div>
                  <table class="table">
                    <tbody>       
                      <?php 
          ...
          <div class="col-xl-6 col-lg-6">
            <div class="card">
                <div class="box box-gold">
                  <div class="card-header">
                    <h3 class="m-0 font-weight-bold text-black" align="center" style="margin-top:21pt;margin-bottom:17pt;"><b>Top #10 Jawaban Aduan Terbaik</b></h3>
                  </div>
                  <table class="table">
                    <tbody>       
                      <?php
  ...
  <div class="modal fade" id="ModalCustomStatistik2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button> -->
          <h4 class="modal-title" id="myModalLabel" align="center"><b>Daftar Aduan Proses</b></h4>
        </div>
        <!-- <form id="form_cetak_antara" class="form-horizontal" action="< ?php echo base_url().'admin/cetak/antara'?>" method="post" enctype="multipart/form-data"> -->
        <form id="form_cetak_antara" class="form-horizontal" action="<?php echo base_url().'admin/dashboard2'?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
