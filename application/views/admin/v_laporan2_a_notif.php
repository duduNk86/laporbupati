...
<body class="hold-transition skin-red sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Aduan dengan Status : <b style="color:red;">Belum Verifikasi</b>
          <small></small>
        </h1>
        <ol class="breadcrumb">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/update_view' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Tindak Lanjut (TL)</label>
              <div class="col-sm-8">
                <textarea name="x_tindaklanjut_view" class="ckeditor" id="x_tindaklanjut_view" rows="3" disabled></textarea>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <textarea type="text" rows="5" name="x_keterangan_tindaklanjut_view" class="form-control" id="x_keterangan_tindaklanjut_view" placeholder="..." disabled></textarea>
              </div>
            </div>
            <div class="form-group">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/input_tindaklanjut' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <textarea name="x_tindaklanjut_inputtl" class="ckeditor" id="x_tindaklanjut_inputtl" rows="3"></textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Tgl. TL</label>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form id="form_teruskan" class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/update_teruskan' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default btn-circle" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary btn-circle" id="simpan"><i class="fa fa-floppy-o">&nbsp; Teruskan</i></button>
          </div>
        </form>
      </div>
    </div>
  </div>
  <!-- Akhir Modal Teruskan -->

  <!-- Awal Modal Kirim Notifikasi WA ke Pengadu -->
  ...
  <!-- Akhir Modal Kirim Notifikasi WA ke Pengadu -->
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      function tampil_data() {
        $.ajax({
          type: 'GET',
          url: '<?php echo base_url() ?>admin/laporan/get_semua_notifadmin',
          async: true,
          dataType: 'json',
          success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
              ...
              html += '<tr>' +
                ...
                '<a href="javascript:;" data-toggle="tooltip" title="Rincian Aduan" class="btn btn-success btn-xs item_view" data="' + data[i].id + '" style="width:90px;"><span class="fa fa-eye"> View</span></a><br>' +
                ...
                '<a href="<?php echo base_url('home/detail/'); ?>' + data[i].id + '" target="_blank" data-toggle="tooltip" title="Lihat Nomor Tiket Aduan" class="btn btn-primary btn-xs item_detail" data="' + data[i].id + '" style="width:90px;"><span class="fa fa-arrow-right"> Tracking</span></a><br>' +
