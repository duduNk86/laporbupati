		                ...
		                html += '<tr>'+
                            ...
                            '<td>'+data[i].ditujukan_kepada+'</td>'+
		                        ...
		                        '<td style="text-align:center;">'+
                                  '<a href="javascript:;" data-toggle="tooltip" title="Lihat Rincian" class="btn btn-success btn-xs item_view" data="'+data[i].id+'"><span class="fa fa-eye"></span></a><br>'+' '+
                                  '<a href="javascript:;" data-toggle="tooltip" title="Tindaklanjut" class="btn btn-warning btn-xs item_tindaklanjut" data="'+data[i].id+'"><span class="fa fa-arrow-right"></span></a><br>'+' '+
