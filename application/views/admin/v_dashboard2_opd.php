...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php 
          $query=$this->db->query("SELECT * FROM tbl_laporan WHERE id_kepada = '$id_kepada'");        
          $jml_laporan=$query->num_rows();
        ?>

        <?php
          $kode=1;
          $hsl=$this->db->query("SELECT * FROM tbl_laporan where laporan_status='$kode' AND id_kepada = '$id_kepada'");        
        ...
        <?php
          $kode=1;
          $hsl=$this->db->query("SELECT * FROM tbl_laporan WHERE id_kepada = '$id_kepada'");        
