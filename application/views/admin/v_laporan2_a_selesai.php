  ...
  <!--Header-->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          Data Aduan dengan Status : <b style="color:red;">Harus Diverifikasi</b>
          <small></small>
          </h1>
          <ol class="breadcrumb">
                    ...
                    <table id="tbl_laporan" class="table table-striped" style="font-size:13px;">
                      <thead>
                        <tr>
                          ...
                          <th style="text-align:center;">Medsos/HP</th>
          ...
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/laporan/update_view'?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">HP / Sumber Kanal Aduan</label>
                  <div class="col-sm-7">                   
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btn-circle" id="simpan"><span class="fa fa-floppy-o"> Simpan</span></button>
              </div>
            </form>
          </div>
        </div>
    ...
    //fungsi tampil data
		function tampil_data(){
		    $.ajax({
		        type  : 'GET',
		        url   : '<?php echo base_url()?>admin/laporan/get_verifikasi',
		        async : true,
		        dataType : 'json',
                ...
                var no=0;
                  ...
                  if (laporan ==1){
                    //  laporan_status = '<span class="label label-success">Verifikasi</span>';
                     laporan_status = '<a href="#" class="btn btn-danger btn-xs item_kirim_pemberitahuan" style="width:90px;">Verifikasi</a>';
                  }else if(laporan ==2){
                    // laporan_status = '<span class="label label-danger">Sedang Proses</span>';
                    laporan_status = '<a href="#" class="btn btn-warning btn-xs item_kirim_pemberitahuan" style="width:90px;">Sedang Proses</a>';
                  }else if(laporan ==99){
                    laporan_status = '<a href="#" class="btn btn-info btn-xs item_kirim_pemberitahuan" style="width:90px;">Ditolak</a>';
                    // laporan_status = '<span class="label label-warning">ditolak</span>';
                  }else{
                    // laporan_status = '<span class="label label-info">selesai</span>';
                    laporan_status = '<a href="#" class="btn btn-success btn-xs item_kirim_pemberitahuan" style="width:90px;">Selesai</a>';
                  }
                  ...
                  if (fileExtension == "pdf") {
                    ...
                    tampilimagefoto = '<img src="'+ base_urlx + data[i].foto +'" style="width:90px;">';
		                ...
		                html += '<tr>'+
                                  ...
                                  '<td style="text-align:center;">'+'<a href="javascript:;" class="btn btn-info btn-xs item_tayang" data="'+data[i].id+'">'+data[i].tayang+'</a>'+'</td>'+
                                  ...
                                  '<td style="text-align:left;">'+
                                      '<div class="btn-group" role="group">'+
                                        ...
                                        '<div class="dropdown-menu">'+
                                          ...
                                          '<a href="javascript:;" data-toggle="tooltip" title="Teruskan Aduan" class="btn btn-info btn-xs item_teruskan" data="'+data[i].id+'" style="width:90px;"><span class="fa fa-paper-plane"> Teruskan</span></a><br>'+
                                          '<a href="<?php echo base_url('home/detail/');?>'+data[i].id+'" data-toggle="tooltip" title="Copylink Progres TL" class="btn btn-primary btn-xs item_detail" data="'+data[i].id+'" style="width:90px;"><span class="fa fa-arrow-right"> Tracking</span></a><br>'+
