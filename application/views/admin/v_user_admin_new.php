        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/useradmin/update_pengguna' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" name="x_pengguna_nohp_edit" class="form-control" placeholder="Whatsapp Admin OPD" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Whatsapp Pimpinan OPD</label>
              <div class="col-sm-7">
                <input type="text" name="x_pengguna_nohp_pimpinan_edit" class="form-control" placeholder="Whatsapp Pimpinan OPD" required>
              </div>
            </div>
            <div class="form-group">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/useradmin/add_pengguna' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Whatsapp Admin OPD</label>
              <div class="col-sm-7">
                <input type="number" name="x_pengguna_nohp" class="form-control" placeholder="Whatsapp Admin OPD" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Whatsapp Pimpinan OPD</label>
              <div class="col-sm-7">
                <input type="number" name="x_pengguna_nohp_pimpinan" class="form-control" placeholder="Whatsapp Pimpinan OPD" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Level</label>
