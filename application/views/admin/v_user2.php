              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      <?php foreach ($users->result_array() as $i) :
                        $id = $i['user_id'];
                        $nama = $i['user_nama'];
                        $hp = $i['user_hp'];
                        $email = $i['user_email'];
                      ...
                      ?>
                        <tr>
                          ...
                          <td> <?php if ($i['user_active'] == "1") { ?>
                              <span class="label label-success">Aktif</span>
                            <?php } else if ($i['user_active'] == "0") { ?>
                              <span class="label label-danger">Belum Aktif</span>
                            <?php } ?>
                          </td>
                          <td style="text-align:right;">
                            <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $id; ?>"><span class="fa fa-pencil"></span></a>
                            <a class="btn" href="<?php echo base_url() . 'admin/pengguna/reset_password/' . $id; ?>"><span class="fa fa-refresh"></span></a>
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/pengguna/simpan_pengguna' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="radio radio-info radio-inline">
                  <input type="radio" id="inlineRadio1" value="1" name="x_level" checked>
                  <label for="inlineRadio1"> Administrator </label>
                </div>
                <div class="radio radio-info radio-inline">
                  <input type="radio" id="inlineRadio1" value="2" name="x_level">
                  <label for="inlineRadio2"> Admin OPD </label>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">No HP/kontak</label>
              <div class="col-sm-7">
                <input type="text" name="xkontak" class="form-control" id="inputUserName" placeholder="No HP " required>
              </div>
            </div>
