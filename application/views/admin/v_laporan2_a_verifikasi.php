    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('admin/laporan'); ?>">Aduan Verifikasi</a></li>
        </ol>
      </section>
      <!-- Main content -->
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/input_tindaklanjut' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Tgl. TL</label>
              <div class="col-sm-8">
                <input type="text" name="x_tanggal_tindaklanjut_inputtl" id="x_tanggal_tindaklanjut_inputtl" class="form-control pull-right datepicker3" required readonly>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Keterangan TL Tambahan</label>
