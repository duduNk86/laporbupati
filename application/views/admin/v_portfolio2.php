    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/cetak/semua'?>" target="_blank"><i class="fa fa-list"></i> Cetak Semua Usulan</a></li>
            <li><a href="<?php echo base_url().'admin/cetak/komisi/5'?>" target="_blank"><i class="fa fa-list"></i> Cetak Usulan Pimpinan</a></li>
            <li><a href="<?php echo base_url().'admin/cetak/komisi/1'?>" target="_blank"><i class="fa fa-list"></i> Cetak Usulan Komisi A</a></li>
            <li><a href="<?php echo base_url().'admin/cetak/komisi/2'?>" target="_blank"><i class="fa fa-list"></i> Cetak Usulan Komisi B</a></li>
            <li><a href="<?php echo base_url().'admin/cetak/komisi/3'?>" target="_blank"><i class="fa fa-list"></i> Cetak Usulan Komisi C</a></li>
            <li><a href="<?php echo base_url().'admin/cetak/komisi/4'?>" target="_blank"><i class="fa fa-list"></i> Cetak Usulan Komisi D</a></li>
          </ul>
        </li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/selesai'?>"><i class="fa fa-list"></i> Daftar TL</a></li>
          </ul>
        </li>
        ...
        <li>
         ...
         <li>
          <a href="<?php echo base_url().'xadmin/administrator/logout'?>">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><span class="fa fa-plus"></span> Add TL</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
