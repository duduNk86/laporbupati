      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/update_laporan' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Foto Aduan</label>
              <div class="col-sm-8" id="foto_aduan_edit_view" name="foto_aduan_edit_view">
                <img src="">
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Ubah Foto Aduan</label>
              <div class="col-sm-8">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/copy_laporan' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Isi Aduan</label>
              <div class="col-sm-8">
                <textarea class="form-control" rows="5" name="x_isi_laporan_copy" id="x_isi_laporan_copy" required></textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Lokasi</label>
          ...
          success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
              ...
              html += '<tr>' +
                ...
                '<td style="text-align:center;">' + laporan_status + '<br><br><b style="color:red">[ ' + data[i].keterangan_tolak + ' ]</b><br><br><b>' + selisihHari + '</b>' + " hari " + '<b>' + jamTl + '</b>' + " jam " + '<b>' + menitTl + '</b>' + " menit " + '<b>' + detikTl + '</b>' + " detik" +
                '<br><br>' + rating + '</td>' +
        ...
        $.ajax({
          ...
          success: function(data) {
            $.each(data, function(i, field) {
              ...
              $('[name="foto_aduan_edit_view"]').html('');
