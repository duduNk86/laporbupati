                  ...
                  <table id="tbl_laporan" class="table table-striped" style="font-size:13px;">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align:center;" title="TL Perangkat Daerah">Tgl-Jam TL | Tindaklanjut</th>
      ...
      <div class="modal-content">
        ...
        <form id="form_tindaklanjut" class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/update_tindaklanjut' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group" id="x_tindaklanjut">
              <label for="inputUserName" class="col-sm-3 control-label">Tindaklanjut (TL)</label>
              <div class="col-sm-8">
                <textarea name="x_tindaklanjut" class="ckeditor" id="x_tindaklanjut"></textarea>
              </div>
            </div>
            <div class="form-group">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/laporan/update_view' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Isi Aduan</label>
              <div class="col-sm-8">
                <textarea class="form-control" rows="5" name="x_isi_laporan_view" id="x_isi_laporan_view" placeholder="Judul Laporan ..." disabled required></textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-3 control-label">Lokasi</label>
              <div class="col-sm-8">
                <input type="text" name="x_lokasi_view" id="x_lokasi_view" class="form-control" disabled required>
              </div>
            </div>
            <div class="form-group">
          ...
          success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
              ...
              if (fileExtension == "pdf") {
                ...
                // tampilimagefoto = '<img src="' + base_urlx + data[i].foto + '" style="width:90px;"><a href="' + base_urlx + data[i].foto + '" target="_blank" style="width:90px;"><br>View Detail</a>';
          ...
          success: function(data) {
            $.each(data, function(i, field) {
              ...
              if (fileExtension == "pdf") {
                ...
                gbr1 += '<a href="' + base_urlx + data[i].foto_tindaklanjut + '" target="_blank" style="width:90px;" title="Klik untuk melihat detail foto TL"><img src="' + base_urlx + data[i].foto_tindaklanjut + '" style="height:250px;width:350px;" alt="no img"></a>';
                $('#foto_tindaklanjut_edit_view').append(gbr1);
              }
