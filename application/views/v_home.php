...
<html class="no-js">
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li><a href="<?php echo base_url().'xadmin/about'?>">About</a></li>
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/imagesdpr.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2> Lapor Bupati Wonosobo</h2>
		   					<h1>Aduan Masyarakat Online</h1>
		   					<p><a href="<?php echo base_url('login');?>" class="btn btn-primary btn-lg">Login</a></p>
		   					<h2>Belum Punya Akun ?</h2>
		   					<p><a href="<?php echo base_url('registrasi');?>" class="btn btn-primary btn-lg">Daftar</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
