        ...
        <section class="content">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Input Aduan</h3>
            </div>
            
            
            <form action="<?php echo base_url().'user/aduan/simpan_aduan'?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="hidden" name="xanggaran" class="form-control" placeholder="anggaran" required/>
                  </div>
                </div>
              </div>
