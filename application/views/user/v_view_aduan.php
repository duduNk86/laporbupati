      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-default">
            ...
            $b=$data->row_array();
            ?>
            <form action="<?php echo base_url().'user/aduan/byid'?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="hidden" name="xanggaran" disabled value ="<?php echo $b['anggaran'];?>" class="form-control" placeholder="anggaran" required/>
                  </div>
                </div>
              </div>
              <div class="box-body">
