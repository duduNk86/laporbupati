      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-default">
            ...
            <form action="<?php echo base_url().'user/laporan/simpan_laporan'?>" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="xjudullaporan" class="form-control" placeholder="Judul Usulan / Laporan" required/>
                  </div>
                </div>
              </div>
              <div class="box-body">
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="textarea" name="xisilaporan" class="form-control" placeholder="Isi Usulan" required/>
                  </div>
                </div>
              </div>
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="xlokasi" class="form-control" placeholder="lokasi" required/>
                  </div>
                </div>
              </div>
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="xanggaran" class="form-control" placeholder="anggaran" required/>
                  </div>
                </div>
              </div>
