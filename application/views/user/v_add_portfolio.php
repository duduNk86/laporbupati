    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'user/tulisan/add_tulisan'?>"><i class="fa fa-thumb-tack"></i> Add New</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'user/portfolio/simpan_portfolio'?>" method="post" enctype="multipart/form-data">
