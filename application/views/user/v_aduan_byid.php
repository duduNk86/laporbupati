    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
              ...
              <div class="box">
                ...
                <div class="box">
                  <div class="box-header">
                    <a class="btn btn-success btn-flat" href="<?php echo base_url().'user/aduan/add_aduan'?>"><span class="fa fa-plus"></span> Tambah Baru</a>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="example2" class="table table-hover" style="font-size:13px;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:left;"><?php echo $judul_laporan;?></td>
                          ...
                          <td style="text-align:left;">
                            <a class="btn" href="<?php echo base_url().'user/aduan/view/'.$id;?>"><span class="fa fa-eye"></span></a>
                            

                            <a class="btn" href="<?php echo base_url().'user/aduan/get_edit/'.$id;?>"><span class="fa fa-pencil"></span></a>
        ...
        <footer class="main-footer">
          ...
          <strong> &copy; 2021 <a href="#">LaporBupati</a>.</strong> .
        </footer>
